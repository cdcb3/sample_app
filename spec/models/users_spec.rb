...
describe User do
  ...
  describe "when email format is valid" do
    it "should be valid" do
      addresses = %w[user@foo.COM THE_US-ER@f.b.org frst.lst@foo.jb a+b@baz.cn]
  ...
  describe "remember token" do
    before { @user.save }
    its(:remember_token) { should_not be_blank } #like it but applies test to the given attribute
  end 
end
